...
export const getAllWAConfigs = () => 
    Axios.get(`${URL_BASE}/setting/wa-notifications`);

export const updateWAConfig = (notificationType, body) => 
    Axios.put(`${URL_BASE}/setting/wa-notifications/${notificationType}`, body);
